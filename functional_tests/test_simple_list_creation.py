...
class NewVisitorTest(FunctionalTest):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        self.wait_for(lambda: self.assert_row_in_list_table('1: Buy peacock feathers'))
        ...
        self.wait_for(lambda: self.assert_row_in_list_table('1: Buy peacock feathers'))
        self.wait_for(lambda: self.assert_row_in_list_table('2: Use peacock feathers to make a fly'))
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        inputbox.send_keys(Keys.ENTER)
        self.wait_for(lambda: self.assert_row_in_list_table('1: Buy milk'))
